...
function darkNav(){
    var navStatus = document.getElementsByClassName("navbar-toggler")[0];
    if(navStatus.classList.contains("collapsed")){
             document.getElementsByTagName("nav")[0].classList.add("darkBg");
    } else if (!navStatus.classList.contains("collapsed")){
...
function lightNav(){
    var navStatus = document.getElementsByClassName("navbar-toggler")[0];
    if(navStatus.classList.contains("collapsed")){
             document.getElementsByTagName("nav")[0].classList.add("lightBg");
    } else if (!navStatus.classList.contains("collapsed")){
            document.getElementsByTagName("nav")[0].classList.remove("lightBg");
    }
}

function myFunction(x) {
  if (x.matches) { // If media query matches
    document.getElementsByClassName("mobileServices")[0].id = "services";
    document.getElementsByClassName("desktopServices")[0].removeAttribute('id');
  } else {
    document.getElementsByClassName("desktopServices")[0].id = "services";
    document.getElementsByClassName("mobileServices")[0].removeAttribute('id');
  }
}
...
navLinks.forEach((l) => {
    l.addEventListener('click', () => {
        ...
        bsCollapse.toggle();
        if(document.getElementsByTagName("nav")[0].classList.contains("lightBg")){
            document.getElementsByTagName("nav")[0].classList.remove("lightBg");
        } else if(document.getElementsByTagName("nav")[0].classList.contains("darkBg")){
            document.getElementsByTagName("nav")[0].classList.remove("darkBg");
        }
    })
